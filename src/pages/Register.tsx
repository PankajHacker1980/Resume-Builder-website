...
import { Brain, Mail, Lock, User, Chrome, Linkedin } from 'lucide-react';
...
export default function Register() {
  ...
  const { register, loginWithGoogle, loginWithLinkedIn, isLoading } = useAuth();
  ...
  const handleLinkedInLogin = async () => {
    try {
      ...
      toast.error('LinkedIn registration failed. Please try again.');
    }
  };
